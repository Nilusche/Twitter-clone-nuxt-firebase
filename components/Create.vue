<template>
    <div>
        ...
        <div class="flex border-b border-twgrey-200 z-0 p-4 mr-0">             
            <div class="flex">
                <span class="flex">
                    <img v-if="!$store.state.user.id|| $store.state.user.id&&  !$store.state.user.profilePic" class=" object-cover rounded-full w-12 h-12 mr-2 hover:contrast-50 transition ease-in-out hover:cursor-pointer" @click="navigateToProfile"  src="https://via.placeholder.com/40" alt="">
