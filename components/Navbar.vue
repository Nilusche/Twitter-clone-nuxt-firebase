<template>
    <div class="hidden lg:flex md:flex sm:flex lg:justify-end justify-start lg:w-auto col-span-1 h-96" style="z-index: 100;">
            <div class="grid grid-cols-1 fixed w-64">
                ...
                <NuxtLink to="/explore" :class="{'font-bold': routename=='/explore'}" class="ml-2 btn lg:w-40  btn-small btn-hover transition ease-in-out">
                ...
                <NuxtLink to="/notifications" :class="{'font-bold': routename=='/notifications'}" class="ml-2 btn lg:w-52 btn-small btn-hover transition ease-in-out">
                    <svg class="inline-block w-7 mb-1 mr-2 h-6 " xmlns="http://www.w3.org/2000/svg"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                    </svg>
                    <span class="lg:visible invisible">Notifications</span> 
                </NuxtLink>
                <NuxtLink to="/messages" :class="{'font-bold': routename=='/messages'}" class="ml-2 btn lg:w-44 btn-small btn-hover transition ease-in-out">
                ...
                <NuxtLink to="/bookmarks" :class="{'font-bold': routename=='/bookmarks'}" class="ml-2 btn lg:w-44 btn-small btn-hover transition ease-in-out">
                    <svg class="inline-block w-7 mb-1 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" />
                    </svg>
                    <span class="lg:visible invisible">Bookmarks</span> 
                </NuxtLink>
                <NuxtLink to="/lists" :class="{'font-bold': routename=='/lists'}" class="ml-2 btn lg:w-32 btn-small btn-hover transition ease-in-out">
                    <svg class="inline-block w-7 mb-1 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                    </svg>
                    <span class="lg:visible invisible">Lists</span>
                </NuxtLink>
                <NuxtLink to="/profile" :class="{'font-bold': routename=='/profile'}" class="ml-2 btn lg:w-36 btn-small btn-hover transition ease-in-out">
                ...
                <NuxtLink to="/more"  class="ml-2 btn lg:w-32  btn-small btn-hover transition ease-in-out">
                ...
                <!--Profile Section-->
                <button class="btn lg:w-56 mt-28  w-20 btn-hover transition ease-in-out">
                    <div class="flex">
                        <img v-if="!user|| user&&  !user.profilePic" class="object-cover flex justify-center w-12 rounded-full mr-2" src="https://picsum.photos/40/40" alt="">
                        <img v-else class="object-cover flex justify-center w-12 rounded-full mr-2" :src="user.profilePic" alt="">
                        <div class="lg:w-25">
