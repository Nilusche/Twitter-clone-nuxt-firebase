<template>
    <div class="hidden lg:flex md:flex sm:flex lg:justify-end justify-start lg:w-auto col-span-1 h-96" style="z-index: 100;">
            <div class="grid grid-cols-1 fixed w-64">
                ...
                <NuxtLink :to="'/' + this.$store.state.user.id" :class="{'font-bold': routename=='/' + this.$store.state.user.id}" class="ml-2 btn lg:w-36 btn-small btn-hover transition ease-in-out">
                ...
                <button class="btn lg:w-56 mt-28  w-20 btn-hover transition ease-in-out">
                    <div class="flex">
                        ...
                        <img v-else class="object-cover flex justify-center w-12 rounded-full mr-2" :src="$store.state.user.profilePic" alt="">
                        <div class="lg:w-25">
